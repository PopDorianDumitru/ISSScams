...
namespace TestSubscriptionService
{
    ...
    public class TestPremiumController
    {
        ...
        public void TestInitialize()
        {
            ...
            MockPost post1 = new MockPost(5, 1, "", "", DateTime.Now);
            MockPost post3 = new MockPost(7, 1, "", "", DateTime.Now);
        ...
        {
            MockPost post = new MockPost(1,1,"","", DateTime.Now);
        ...
        {
            MockPost post = new MockPost(2, 2, "", "", DateTime.Now);
        ...
        {
            MockPost post = new MockPost(3, 1, "", "", DateTime.Now);
        ...
        {
            MockPost post = new MockPost(4, 2, "", "", DateTime.Now);
            mockPostRepository.Insert(post);
            bool expectedResult = false;
            bool result = premiumPostController.DeletePremiumPost(post);
            Assert.AreEqual(expectedResult, result);
        ...
        {
            MockPost post2 = new MockPost(6, 1, "", "", DateTime.Now);
            MockPost post4 = new MockPost(8, 1, "", "", DateTime.Now);
