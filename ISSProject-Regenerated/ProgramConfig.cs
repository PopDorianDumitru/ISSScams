...
namespace ISSProject
{
    internal class ProgramConfig
    {
        ...
        public static readonly string DATABASE_CONNECTION_STRING = $"Data Source = {Environment.MachineName}; Initial Catalog = CelebrationOfCapitalism ; Integrated Security = True; TrustServerCertificate=True";
    }
}
