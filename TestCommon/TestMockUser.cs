...
namespace TestCommon
{
    ...
    public class TestMockUser
    {
        ...
        public void ToString_AllConstructors_ShouldReturnTheStringRepresentationOfTheObject()
        {
            ...
            Assert.AreEqual(user2.ToString(), "User Luca Ratan, with ID 1, born on 4/26/2022 10:30:00 AM, having email address iss@yahoo.com and phone number ");
            Assert.AreEqual(user3.ToString(), "User Luca Ratan, with ID 1, born on 4/26/2022 10:30:00 AM, having email address iss@yahoo.com and phone number ");
            Assert.AreEqual(user4.ToString(), "User Luca Ratan, with ID 1, born on 4/26/2022 10:30:00 AM, having email address iss@yahoo.com and phone number 0731427290");
            Assert.AreEqual(user5.ToString(), "User Luca Ratan, with ID -1, born on 4/26/2022 10:30:00 AM, having email address iss@yahoo.com and phone number 0731427290");
        }
